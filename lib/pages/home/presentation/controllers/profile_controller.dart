...
class ProfileController extends SuperController<User> {
...
//    appwriteLogin();
  ...
  void checkLogin() async {
    ...
    print('ProfileController***** User existed is ' + userExisted.toString());
...
//    print("isLogin is " + isLogin.toString());
    if (isLogin!) {
      print('authRepository.user' + authRepository.user.toString());
